...
const Dashboard = () => {
  ...
  return (
    <div className="bg-purple-100 h-auto w-full">
    <div className="flex">
        <div className={`duration-500 relative border-r-2 border-gray-300 bg-white h-auto pl-4 py-4  ${sideOpen ? "w-64" : "w-20" }`}>
            <div className="flex">
            ...
            <hr className="mt-2 mr-4 border-b-1 border-gray-300"/>
            <div className="">
                {
